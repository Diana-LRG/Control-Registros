...
import com.example.registroscontrol.Constants.Companion.MINIMUM_SENIORITY_FREE_RETARDANT
import com.example.registroscontrol.Constants.Companion.NUMBER_OF_RETARDANT_EQUIVALENT_TO_ONE_ABSENCE
import java.time.LocalDate

class Incident (val employee: Employee,
